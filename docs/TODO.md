...
## [EP-1] Phase 1: AI 코드 분석 MVP (2~3주) — 핵심 차별점

> 목표: 이슈를 클릭하면 AI가 실제 코드를 분석해서 영향 파일과 수정 제안을 보여준다

### LLM 연동 `label:llm`

- [ ] **P1-1. Ollama + LLM Adapter 구현**
...
- [ ] **P1-2. Git bare clone + 코드 인덱싱 파이프라인**
...
## [EP-2] Phase 2: 인증 + 풀 CRUD + Jira 연동 (4~5주)
