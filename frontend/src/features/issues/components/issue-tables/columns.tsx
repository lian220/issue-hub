...
export function createIssueColumns(lookups: IssueListLookups): ColumnDef<Issue>[] {
  return [
    {
      id: "priority",
      header: "",
    ...
    },
    {
      ...
      cell: ({ row }) => {
        ...
        const hasAi = !!lookups.aiAnalyses[issue.id];
        return (
    ...
    },
    {
      ...
      header: "담당자",
      cell: ({ row }) => {
        const assignee = lookups.teamMembers.find((m) => m.id === row.original.assigneeId);
